...
export class TransmissionRequest {
    ...
    constructor(messageID: number, messageTask: string, messageContent: any, callback: (messageData: any)=>(void)) {
...
export class TransmissionServer {
    ...
    listeners = new Map<string, (messageData: any)=>(Promise<any>)>();
    connectedSockets: WebSocket[] = [];
    authenticationKey: string | null;

    constructor(webSocketServer: WebSocketServer, authenticationKey: string | null = null) {
        ...
        webSocketServer.on("connection", (socket) => {
            ...
            let processTransmissionMessage = (recievedMessage: any)=>{
...
export class Transmission {
    ...
    private runningWebSocket: WebSocket | null = null;
    private globalMessageListeners = new Map();
    private pendingRequests = new Map();
    private authenticationKey: string | null;
